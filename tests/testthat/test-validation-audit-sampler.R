context("9. Benchmark against AuditSampler package")
...
test_that(desc = "(id: f3-v0.4.0-t1) Test Sample sizes for binomial distribution", {
  ...
  auditSamplerMatrix <- matrix(data = c(114, 194, 194, 265, 398, rep(NA, 14), # 2%
                                        ...
                                        32, 55, 55, 55, 55, 55, 55, 55, 75, 75, 75, 94, 94, 112 + 1, 112 + 1, 131, 149, 218, rep(NA, 1), # 7% # AuditSampler says 112 but must be 113 --> sum(dbinom(0:4, size = 112, prob = 0.07)) > 0.10

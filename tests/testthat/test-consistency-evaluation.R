...
test_that(desc = "(id: f3-v0.6.0-t1) Test Bayes factors for beta prior", {
  ...
  # BF-+ = 696.696
  BF <- evaluation(materiality = 0.03, n = 160, x = 1, prior = auditPrior(method = 'param', alpha = 1, beta = 1, likelihood = 'binomial'))$posterior$hypotheses$bf.hmin
  ...
  # BF-+ = 51.55
  BF <- evaluation(materiality = 0.05, n = 50, x = 1, prior = auditPrior(method = 'param', alpha = 1, beta = 1, likelihood = 'binomial'))$posterior$hypotheses$bf.hmin
  ...
  # BF-+ = 2.58
  BF <- evaluation(materiality = 0.05, n = 50, x = 1, prior = auditPrior(method = 'param', alpha = 1, beta = 0, likelihood = 'binomial'))$posterior$hypotheses$bf.hmin
...
test_that(desc = "(id: f3-v0.6.0-t3) Test Bayes factors for beta-binomial prior", {
  ...
  BF <- evaluation(materiality = 0.03, n = 160, x = 1, prior = auditPrior(method = 'default', likelihood = "hypergeometric", N.units = 1000))$posterior$hypotheses$bf.hmin
  expect_equal(BF, 1248.71551)
  
  # Compute a Bayes factor from a noninformative beta-binomial prior
  BF <- evaluation(materiality = 0.05, n = 50, x = 1, prior = auditPrior(method = 'default', likelihood = "hypergeometric", N.units = 1000))$posterior$hypotheses$bf.hmin

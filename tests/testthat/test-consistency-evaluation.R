...
test_that(desc = "(id: f3-v0.1.0-t2) Evaluation with Poisson method with prior", {
  ...
  samp <- selection(population, sampleSize = jfaRes, units = "records", algorithm = "random", ordered = TRUE)$sample
  samp$auditValue <- samp[["bookValue"]]
  jfaEval <- evaluation(confidence = 0.95, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "poisson", prior = TRUE, materiality = 0.05)
...
test_that(desc = "(id: f3-v0.1.0-t3) Evaluation with binomial method", {
  ...
  samp <- selection(population, sampleSize = jfaRes, units = "records", algorithm = "random", ordered = TRUE)$sample
  samp$auditValue <- samp[["bookValue"]]
  jfaEval <- evaluation(confidence = 0.95, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "binomial", materiality = 0.05)
...
test_that(desc = "(id: f3-v0.1.0-t6) Evaluation with hypergeometric method with prior", {
  ...
  samp <- selection(population, sampleSize = jfaRes, units = "records", algorithm = "random", ordered = TRUE)$sample
  samp$auditValue <- samp[["bookValue"]]
  jfaEval <- evaluation(confidence = 0.95, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "hypergeometric", N = 1000, prior = TRUE, materiality = 0.05)
...
test_that(desc = "(id: f3-v0.1.0-t7) Evaluation with stringer method", {
  ...
  samp <- selection(population, sampleSize = jfaRes, units = "records", algorithm = "random", ordered = TRUE)$sample
  samp$auditValue <- samp[["bookValue"]]
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "stringer")
  expect_equal(jfaEval[["confBound"]], 0.04870291, tolerance = 0.001)
})
...
test_that(desc = "(id: f3-v0.1.0-t8) Evaluation with stringer-meikle method", {
  ...
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "stringer-meikle")
...
test_that(desc = "(id: f3-v0.1.0-t9) Evaluation with stringer-lta method", {
  ...
  samp$auditValue[5] <- samp[["bookValue"]][5] - (0.6 * samp[["bookValue"]][5]) # Add an overstatement
  samp$auditValue[6] <- samp[["bookValue"]][6] - (0.6 * samp[["bookValue"]][6]) # Add an overstatement
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "stringer-lta")
...
test_that(desc = "(id: f3-v0.1.0-t10) Evaluation with stringer-pvz method", {
  ...
  samp$auditValue[5] <- samp[["bookValue"]][5] - (0.6 * samp[["bookValue"]][5]) # Add an overstatement
  samp$auditValue[6] <- samp[["bookValue"]][6] - (0.6 * samp[["bookValue"]][6]) # Add an overstatement
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "stringer-pvz")
...
test_that(desc = "(id: f3-v0.1.0-t11) Evaluation with rohrbach method", {
  ...
  samp <- selection(population, sampleSize = jfaRes, units = "records", algorithm = "random", ordered = TRUE)$sample
  samp$auditValue <- samp[["bookValue"]]
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "rohrbach", N = 1000)
...
test_that(desc = "(id: f3-v0.1.0-t12) Evaluation with moment method", {
  ...
  samp <- selection(population, sampleSize = jfaRes, units = "records", algorithm = "random", ordered = TRUE)$sample
  samp$auditValue <- samp[["bookValue"]]
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "moment", N = 1000, momentPoptype = "accounts")
  expect_equal(jfaEval[["confBound"]], 0.04916021, tolerance = 0.001)
  
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "moment", N = 1000, momentPoptype = "inventory")
  expect_equal(jfaEval[["confBound"]], 0.04916021, tolerance = 0.001)
...
test_that(desc = "(id: f3-v0.1.0-t13) Evaluation with direct method", {
  ...
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = BuildIt_sample, bookValues = "bookValue", auditValues = "auditValue", method = "direct", N = 3500, populationBookValue = sum(BuildIt$bookValue))
...
test_that(desc = "(id: f3-v0.1.0-t14) Evaluation with difference method", {
  ...
  BuildIt$inSample <- c(rep(1, 100), rep(0, 3400))
  BuildIt_sample <- subset(BuildIt, BuildIt$inSample == 1)
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = BuildIt_sample, bookValues = "bookValue", auditValues = "auditValue", method = "difference", N = 3500, populationBookValue = sum(BuildIt$bookValue))
...
test_that(desc = "(id: f3-v0.1.0-t15) Evaluation with quotient method", {
  ...
  BuildIt$inSample <- c(rep(1, 100), rep(0, 3400))
  BuildIt_sample <- subset(BuildIt, BuildIt$inSample == 1)
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = BuildIt_sample, bookValues = "bookValue", auditValues = "auditValue", method = "quotient", N = 3500, populationBookValue = sum(BuildIt$bookValue))
  expect_equal(jfaEval[["mle"]], 34298.6, tolerance = 0.001)
...
test_that(desc = "(id: f3-v0.1.0-t17) Evaluation with Cox and Snell method", {
  ...
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "coxsnell")
...
test_that(desc = "(id: f3-v0.3.0-t1) Evaluation with counts and stringer method", {
  ...
  jfaEval <- evaluation(confidence = 0.95, materiality = 0.05, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "stringer", count = counts)
...
test_that(desc = "(id: f3-v0.2.0-t3) Test for frequentist plot function", {
  ...
  jfaEval <- evaluation(confidence = 0.95, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "hypergeometric", materiality = 0.05, N = nrow(population))
  invisible(capture.output(plot(jfaEval)))
...
test_that(desc = "(id: f3-v0.2.0-t4) Test for Bayesian plot function", {
  ...
  jfaEval <- evaluation(confidence = 0.95, sample = samp, bookValues = "bookValue", auditValues = "auditValue", method = "hypergeometric", prior = TRUE, materiality = 0.05, N = nrow(population))
  invisible(capture.output(plot(jfaEval)))

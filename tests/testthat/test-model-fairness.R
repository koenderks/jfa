...
test_that(desc = "Benchmark against fairness package", {
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["dp"]], as.numeric(fairness_dp[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["dp"]], as.numeric(fairness_dp[2, ]))
  # Proportional parity
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["pp"]], as.numeric(fairness_pp[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["pp"]], as.numeric(fairness_pp[2, ]))
  ...
  expect_equal(from_jfa[["ratio"]][["mle"]][["prp"]], as.numeric(fairness_prp[2, ]))
  # Accuracy parity
  ...
  expect_equal(from_jfa[["ratio"]][["mle"]][["ap"]], as.numeric(fairness_ap[2, ]))
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["fnrp"]], as.numeric(fairness_fnr[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["fnrp"]], as.numeric(fairness_fnr[2, ]))
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["fprp"]], as.numeric(fairness_fpr[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["fprp"]], as.numeric(fairness_fpr[2, ]))
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["tprp"]], as.numeric(fairness_tpr[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["tprp"]], as.numeric(fairness_tpr[2, ]))
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["npvp"]], as.numeric(fairness_npv[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["npvp"]], as.numeric(fairness_npv[2, ]))
  # Specificity parity
  ...
  expect_equal(from_jfa[["metrics"]][["mle"]][["sp"]], as.numeric(fairness_sp[1, ]))
  expect_equal(from_jfa[["ratio"]][["mle"]][["sp"]], as.numeric(fairness_sp[2, ]))
  # Plot
  p <- plot(from_jfa)

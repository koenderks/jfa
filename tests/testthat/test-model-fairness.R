...
test_that(desc = "Benchmark against fairness package", {
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["dp"]], as.numeric(fairness_dp[2, ]))
  # Proportional parity
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["pp"]], as.numeric(fairness_pp[2, ]))
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["prp"]], as.numeric(fairness_prp[2, ]))
  # Accuracy parity
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["ap"]], as.numeric(fairness_ap[2, ]))
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["fnrp"]], as.numeric(fairness_fnr[2, ]))
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["fprp"]], as.numeric(fairness_fpr[2, ]))
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["tprp"]], as.numeric(fairness_tpr[2, ]))
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["npvp"]], as.numeric(fairness_npv[2, ]))
  # Specificity parity
  ...
  expect_equal(from_jfa[["odds"]][["all"]][["sp"]], as.numeric(fairness_sp[2, ]))
  # Plot
  p <- plot(from_jfa)

...
test_that(desc = "Benchmark against fairness package", {
  data("compas")
  # Demographic parity
  jfa_dp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "dp")
  ...
  # Proportional parity
  jfa_pp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "pp")
  ...
  jfa_prp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "prp")
  ...
  expect_equal(jfa_prp[["performance"]][["all"]][["precision"]], as.numeric(fairness_prp[1, ]))
  expect_equal(jfa_prp[["parity"]][["all"]][["estimate"]], as.numeric(fairness_prp[2, ]))
  # Accuracy parity
  jfa_ap <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "ap")
  ...
  expect_equal(jfa_ap[["performance"]][["all"]][["accuracy"]], as.numeric(fairness_ap[1, ]))
  expect_equal(jfa_ap[["parity"]][["all"]][["estimate"]], as.numeric(fairness_ap[2, ]))
  # False negative rate parity
  jfa_fnrp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "fnrp")
  ...
  jfa_fprp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "fprp")
  ...
  jfa_tprp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "tprp")
  ...
  jfa_npvp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "npvp")
  ...
  # Specificity parity
  jfa_sp <- model_fairness(compas, "Ethnicity", "TwoYrRecidivism", "Predicted", reference = "Caucasian", positive = "yes", metric = "sp")

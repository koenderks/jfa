...
for(rows in 1:length(n)){
  for(columns in 1:length(k)){
      tab[rows, columns] <- log(evaluation(materiality = 0.10, n = n[rows], x = k[columns], method = 'poisson', prior = TRUE)$posterior$hypotheses$bf.hmin)
  }
}
...
for(rows in 1:length(n)){
  for(columns in 1:length(k)){
      tab[rows, columns] <- log(evaluation(materiality = 0.05, n = n[rows], x = k[columns], method = 'poisson', prior = TRUE)$posterior$hypotheses$bf.hmin)
  }
}
...
for(rows in 1:length(n)){
  for(columns in 1:length(k)){
      tab[rows, columns] <- log(evaluation(materiality = 0.02, n = n[rows], x = k[columns], method = 'poisson', prior = TRUE)$posterior$hypotheses$bf.hmin)
  }
}
...
for(rows in 1:length(n)){
  for(columns in 1:length(k)){
      tab[rows, columns] <- log(evaluation(materiality = 0.01, n = n[rows], x = k[columns], method = 'poisson', prior = TRUE)$posterior$hypotheses$bf.hmin)
  }
}

...
```{r downloads, echo = FALSE, message = FALSE, warning=FALSE, fig.align='center'}
...
yBreaks           <- pretty(c(0, plotData[["count"]], max(plotData[["count"]]) + 200))
...
p <- ggplot2::ggplot(plotData, ggplot2::aes(x = date, y = count)) +
      ggplot2::geom_bar(stat = "identity", fill = rgb(65, 104, 195, 200, maxColorValue = 255), col = "black", size = 1) +

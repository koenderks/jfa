...
To validate the statistical results, `jfa`'s output is currently being verified against the following benchmarks:
...
Below you can find several informative tables that contain statistical sample sizes, upper limits, and Bayes factors. These tables are generated using the available functions in the `jfa` package.

...
Additionally, there are several cheat sheets available that contain tables with statistical sample sizes. These tables are generated using `jfa`.

- [Statistical Sample Sizes based on the Binomial Distribution](https://github.com/koenderks/jfa/raw/master/man/figures/tables/jfaBinomialSampleSizes.pdf)
- [Statistical Sample Sizes based on the Poisson Distribution](https://github.com/koenderks/jfa/raw/master/man/figures/tables/jfaPoissonSampleSizes.pdf)

...
plot.jfaFairnessSelection <- function(x, ...) {
  ...
  if (measure == "Predictive Rate Parity") {
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_label(ggplot2::aes(x = -11.8, y = -14, label = "POSITIVE (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_label(ggplot2::aes(x = -4, y = -14, label = "NEGATIVE (2)"), fill = "lightgray", size = 3) +
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_label(ggplot2::aes(x = -12, y = -14, label = "POSITIVE (1)"), fill = "lightgrey", size = 3) +
      ...
      ggplot2::geom_label(ggplot2::aes(x = -4, y = -14, label = "NEGATIVE (2)"), color = "black", size = 3) +
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_label(ggplot2::aes(x = -1.75, y = -14, label = "NEGATIVE (2)"), fill = "lightgray", size = 3)

...
print.jfaFairnessSelection <- function(x, ...) {
  ...
  cat("\n")
  cat("The answer to the first question is:", x[["q1"]])
  cat("\n")
  cat("The answer to the second question is:", x[["q2"]])
  cat("\n")
  cat("The answer to the third question is:", x[["q3"]])
  cat("\n")
...
plot.jfaFairnessSelection <- function(x, ...) {
  ...
  if (measure == "Predictive Rate Parity") {
    rects <- data.frame(
      xmin = c(-0.8, -6, 5.5, -11.4, -2.2, 5.5, -15.7, -6.4, -20, -10.5),
      xmax = c(6.2, 0.2, 9.5, -4, 3.2, 9.5, -9.8, -0.8, -14.5, -5.8),
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::ylim(-28, 7) +
      ggplot2::theme_void() +
      ggplot2::geom_segment(ggplot2::aes(x = -0.8, xend = -3.1, y = 3, yend = -0.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "black", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -3.5, y = 1, label = "YES (1)"), color = "black", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = 6.2, xend = 7.5, y = 3, yend = -0.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 8.3, y = 1, label = "NO (2)"), color = "darkgrey", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -6, xend = -7.7, y = -4.1, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "black", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -9.4, y = -6, label = "CORRECT (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -3.8, y = -6, label = "INCORRECT (2)"), color = "darkgray", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 9.4, y = -6, label = "CORRECT AND INCORRECT (3)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -13.3, y = -14, label = "ENP (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -2.8, y = -14, label = "WD (2)"), color = "darkgray", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -17.7, y = -20.5, label = "FP (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -7.5, y = -20.5, label = "FN (2)"), color = "darkgray", size = 3)
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -17.7, y = -20.5, label = "FP (1)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -7.5, y = -20.5, label = "FN (2)"), color = "black", size = 3)
  } else if (measure == "Specificity Parity") {
    rects <- data.frame(
      xmin = c(-0.8, -6, 5.5, -11.4, -2.2, 5.5, -15.7, -6.4, -12, -5.3, 2),
      xmax = c(6.2, 0.2, 9.5, -4, 3.2, 9.5, -9.8, -0.8, -8, -0.7, 6),
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_segment(ggplot2::aes(x = 6.2, xend = 7.5, y = 3, yend = -0.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 8.3, y = 1, label = "NO (2)"), color = "darkgrey", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -6, xend = -7.7, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "black", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -9.4, y = -6, label = "CORRECT (1)"), color = "black", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -2.6, xend = 0.5, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgray", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -3.8, y = -6, label = "INCORRECT (2)"), color = "darkgray", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -13.3, y = -14, label = "ENP (1)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -2.8, y = -14, label = "WD (2)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -9.7, y = -20.5, label = "FP (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -4.9, y = -20.5, label = "FN (2)"), color = "darkgray", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 5.6, y = -20.5, label = "NO PREFERENCE (3)"), color = "darkgray", size = 3)
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -9.7, y = -20.5, label = "FP (1)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -4.9, y = -20.5, label = "FN (2)"), color = "black", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -0.8, xend = 4, y = -19, yend = -21.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgray", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 5.6, y = -20.5, label = "NO PREFERENCE (3)"), color = "darkgray", size = 3)
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_segment(ggplot2::aes(x = -6.4, xend = -10, y = -19, yend = -21.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -9.7, y = -20.5, label = "FP (1)"), color = "darkgrey", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -3.6, xend = -3.6, y = -19, yend = -21.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -4.9, y = -20.5, label = "FN (2)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 5.6, y = -20.5, label = "NO PREFERENCE (3)"), color = "black", size = 3)
  } else if (measure == "False Positive Rate Parity") {
    rects <- data.frame(
      xmin = c(-0.8, -6, 5.5, -11.4, -2.2, 5.5, -18, -9, -4.2, 0.8),
      xmax = c(6.2, 0.2, 9.5, -4, 3.2, 9.5, -12, -3, 0.2, 5.2),
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_segment(ggplot2::aes(x = 6.2, xend = 7.5, y = 3, yend = -0.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 8.3, y = 1, label = "NO (2)"), color = "darkgrey", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -6, xend = -7.7, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -9.4, y = -6, label = "CORRECT (1)"), color = "darkgrey", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -2.6, xend = 0.5, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "black", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -3.8, y = -6, label = "INCORRECT (2)"), color = "black", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = 0.2, xend = 7.5, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 9.4, y = -6, label = "CORRECT AND INCORRECT (3)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -15, y = -18, label = "ENP (1)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -6.5, y = -18, label = "WD (2)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -3.4, y = -14, label = "FP (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 4.4, y = -14, label = "FN (2)"), color = "darkgrey", size = 3)
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -3.4, y = -14, label = "FP (1)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 4.4, y = -14, label = "FN (2)"), color = "black", size = 3)
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -2.4, y = 1, label = "YES (1)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 7.6, y = 1, label = "NO (2)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -7.7, y = -6, label = "CORRECT (1)"), color = "darkgray", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -3, y = -6, label = "INCORRECT (2)"), color = "darkgray", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = 0, xend = 7.25, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "black", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 8.4, y = -6, label = "CORRECT AND INCORRECT (3)"), color = "black", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -12.5, y = -14, label = "ENP (1)"), color = "darkgray", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -0.5, y = -14, label = "WD (2)"), color = "darkgray", size = 3)
    ...
    plotWorkflow <- ggplot2::ggplot() +
      ...
      ggplot2::geom_text(ggplot2::aes(x = -2.4, y = 1, label = "YES (1)"), color = "darkgrey", size = 3) +
      ...
      ggplot2::geom_text(ggplot2::aes(x = 7.6, y = 1, label = "NO (2)"), color = "black", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -4.2, xend = -7, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgray", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -7.7, y = -6, label = "CORRECT (1)"), color = "darkgray", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -2.1, xend = 0.5, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgray", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -3, y = -6, label = "INCORRECT (2)"), color = "darkgray", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = 0, xend = 7.25, y = -4, yend = -7.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgrey", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = 8.4, y = -6, label = "CORRECT AND INCORRECT (3)"), color = "darkgrey", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -10, xend = -12.5, y = -12, yend = -15.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgray", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -12.5, y = -14, label = "ENP (1)"), color = "darkgray", size = 3) +
      ggplot2::geom_segment(ggplot2::aes(x = -4, xend = 0.5, y = -12, yend = -15.87), arrow = ggplot2::arrow(length = ggplot2::unit(0.05, "inches")), color = "darkgray", size = 1) +
      ggplot2::geom_text(ggplot2::aes(x = -0.5, y = -14, label = "WD (2)"), color = "darkgray", size = 3)

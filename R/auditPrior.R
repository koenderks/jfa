...
#' @param N               an integer (or numeric value) larger than 0 specifying the total population size (or value). Only required when \code{likelihood = 'hypergeometric'}.
#' @param materiality     a numeric value between 0 and 1 specifying the performance materiality (i.e., maximum upper limit) of the audit as a fraction of the total size (or value). Can be \code{NULL} for some methods.

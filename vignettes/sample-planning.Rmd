...
However, it is considerably larger larger than the minimal sample size for the
first stage if the auditor decides to use a single-stage sampling plan expecting
$k$ = 1, which is $n$ = 157.

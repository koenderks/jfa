...
Using the `evaluation()` function the auditor can create the prior distribution and calculate the Bayes factor in favor of acceptance of the lot versus rejection of the lot. In this case, the Bayes factor in favor of acceptance ($BF_{-+}$) is 5.814 and represents only moderate evidence in favor of acceptance (see also the vignette [Testing misstatement](https://koenderks.github.io/jfa/articles/v6_testing_misstatement.html)).
...
The Bayes factor in favor of acceptance after the second sample of items is 70.402 which represents strong evidence in favor of acceptance.

...
The number of units per stratum in the population can be provided with `N.units` to weigh the stratum estimates to determine population estimate (i.e., poststratification).
...
In this case, the output shows that the estimate of the misstatement in the population is 15.77%, with the 95% (one-sided) confidence interval ranging from 0% to 17.31%.
...
The output shows that the estimate of the misstatement in the population is 15.75%, with the 95% (one-sided) credible interval ranging from 0% to 17.49%.
...
In this case, the output shows that the estimate of the misstatement in the population is 21.88%, with the 95% confidence interval ranging from 19.27% to 24.70%. The stratum estimates can be seen in the output of the `summary()` function and are visualized below.
...
The output shows that the estimate of the misstatement in the population is 1.89%, with the 95% credible interval ranging from 0.98% to 3.92%. The stratum estimates can be seen in the output of the `summary()` function and are visualized below.

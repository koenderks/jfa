...
population is 4.16 percent, with the 95 percent credible interval extending from
3.30 percent to 5.29 percent. Note that this population estimate is considerably
...
audited as part of the sample in the column `times`. sampled. In this scenario,
we will be performing estimation and therefore do not specify the `materiality`
...
extends from 0 percent to 17.5 percent. More detailed information can be
...
percent to 17.49 percent. More detailed information can be obtained via
...
12.55 percent to 18.28 percent. The precision of the population estimate is
therefore 3.56 percent. The estimates for each stratum are visualized below. For
...
15.64 percent. The 95 percent credible interval spans from 13.48 percent to
18.1 percent. The precision of the population estimate is therefore 2.46

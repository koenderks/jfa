...
The `digit.test()` function can be used to test the distribution of leading or last digits in a variable against a pre-specified distribution (e.g., Benford's law).
...
The `repeated.test()` function can be used to test the numbers in a variable for repeated values.

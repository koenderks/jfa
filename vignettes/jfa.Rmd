...
To illustrate `jfa` statistical audit sampling functionality, consider the `BuildIt` data set that comes with the package. This data consists of 3500 financial statement line items, each of which has a booked value and (for illustrative purposes) a true (audit) value.

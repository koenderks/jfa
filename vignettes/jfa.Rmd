...
sampling, data auditing, and algorithm auditing. The package is divided into
three sections: audit sampling, data auditing, and algorithm auditing. This page
points you to the vignettes accompanying each of the three sections.

## Audit sampling

Firstly, the package provides functions for planning, performing, and evaluating
an audit sample compliant with international standards on auditing [@iaasb_2018;
@aicpa_2021; @pcaob_2020].
...
Secondly, the package includes functions for auditing data, such as testing the
distribution of first digits of a data set against Benford's law, or assessing
the amount of repeated values in a data set.
...
Finally, the package implements functions for auditing algorithms, such as
computing and testing fairness metrics for predictive models.

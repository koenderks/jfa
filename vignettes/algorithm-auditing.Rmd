...
auditing of algorithms and predictive models. Specifically, the functions in
this section implement techniques to calculate and test fairness metrics. The
**jfa** package enables users to create a prior probability distribution to
perform Bayesian algorithm auditing using these functions.
...
metrics between an unprivileged protected class and a privileged protected
...
The cheat sheet below will help you get started with **jfa**'s' intended
algorithm audit functionality. You can download a `pdf` version of the cheat
sheet [here](https://github.com/koenderks/jfa/raw/development/man/figures/cheatsheet/cheatsheet-algorithm.pdf).

...
The fairness_selection() function offer a method to select a fairness measure 
...
functions, we will use a renowned dataset known as COMPAS. The COMPAS 
...
It is worth noticing that the function can also be called without any 

---
title: "Audit sampling: Bayesian sampling workflow"
author: Koen Derks
...
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Audit sampling: Bayesian sampling workflow}
...
![Figure 1: Illustration of the audit sampling workflow](img/workflow.png)\
...
![Figure 2: The location of the planning stage in the audit sampling workflow](img/planning.png)\
...
![Figure 3: The location of the selection stage in the audit sampling workflow](img/selection.png)\
...
![Figure 4: The location of the evaluation stage in the audit sampling workflow](img/evaluation.png)\

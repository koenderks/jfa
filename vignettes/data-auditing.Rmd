...
auditing. Specifically, the functions in this section implement techniques to
test the distribution of (leading) digits against a reference distribution
(e.g., Benford's law) and techniques to assess whether values are repeated more
often than expected. The **jfa** package enables users to create a prior
probability distribution to perform Bayesian data auditing using these
functions.
...
digits [@yu_2018]. We can use the `repeated.test()` function to test if these
...
The cheat sheet below will help you get started with **jfa**'s' intended data
audit functionality. You can download a `pdf` version of the cheat sheet
[here](https://github.com/koenderks/jfa/raw/development/man/figures/cheatsheet/cheatsheet-data.pdf).

...
conclude with 91.66 percent confidence that the misstatement in BuildIt's
population is lower than the performance materiality of 5 percent.
...
function. The resulting 91.66 percent upper bound is 1.396 percent, which is
lower than the performance materiality of 5 percent.
...
Since the 91.66 percent upper confidence bound on the misstatement in population
is lower than the performance materiality, the auditor has obtained sufficient

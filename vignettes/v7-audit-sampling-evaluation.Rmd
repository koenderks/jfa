...
For example, the output shows that the population level estimate is 4.4% with an 95% upper bound of 5.2%.
...
In this case, the output shows that the population level estimate is 5.6% with an 95% upper bound of 7.6%.
...
In this case, the output shows that the population level estimate is 4.3% with an 95% upper bound of 5.1%.

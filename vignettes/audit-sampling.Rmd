...
statistical audit sampling workflow. Specifically, the functions in this section
implement standard audit sampling techniques to calculate sample sizes, select
items from a population, and evaluate misstatement in a data sample. The **jfa**
package enables users to create a prior probability distribution to perform
...
[here](https://github.com/koenderks/jfa/raw/development/man/figures/cheatsheet/cheatsheet-sampling.pdf).

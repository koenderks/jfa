...
items from a population, and evaluate the misstatement in a data sample. The
package allows enables to specify a prior probability distribution to conduct

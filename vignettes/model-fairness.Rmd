...
[@calders_2010; @chouldechova_2017; @feldman_2015; @zafar_2017; @friedler_2019].
...
privileged group (Caucasian). See @pessach_2022 for a more detailed
...
provides credible intervals and Bayes factors [@jamil_2017]. Like in the other
functions in `jfa`, performing a Bayesian analysis using a default prior can be
achieved by setting `prior = TRUE`.

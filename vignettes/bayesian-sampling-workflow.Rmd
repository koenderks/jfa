...
function. The resulting upper bound is 2.278%, which is lower than the
performance materiality of 5%. Therefore, the auditor can concluse that there is
a 95 percent probability that the misstatement in BuildIt's population is lower
than 2.278 percent.

...
As an example, the code below shows how to apply the random sampling method in a record sampling and a monetary unit sampling setting. It is important to set a seed to make results reproducible.

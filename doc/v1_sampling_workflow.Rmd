...
Laura can inspect the outcomes of her inference by using the `summary()` function. Her resulting upper bound is 1.564%, which is lower than the materiality of 5%. The output tells Laura the correct conclusion immediately.

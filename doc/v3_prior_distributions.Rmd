...
You can manually specify the $\alpha$ and $\beta$ parameters of the prior distribution using `method = 'custom'` in combination with the `alpha` and `beta` arguments. As an example, the code below creates a beta(2, 10) prior distribution.

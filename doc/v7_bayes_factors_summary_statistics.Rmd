---
title: "Evaluation: Bayes factors using summary statistics"
author: Koen Derks
...
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Evaluation: Bayes factors using summary statistics}
...
Using the `evaluation()` function the auditor can create the prior distribution and calculate the Bayes factor in favor of acceptance of the lot versus rejection of the lot. In this case, the Bayes factor in favor of acceptance ($BF_{-+}$) is 0.277 and represents only anecdotal evidence in favor of rejection (see also the vignette [Testing misstatement](https://koenderks.github.io/jfa/articles/v6_testing_misstatement.html)).
...
The Bayes factor in favor of acceptance after the second sample of items is 3.468 which represents moderate evidence in favor of acceptance.

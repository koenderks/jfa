...
where $N$ is the number of units in the population. To clarify this procedure, Figure 1 provides an illustration of the random sampling algorithm.
...
with the property that the space between selected units $i$ is the same as the interval $I$, see Figure 2. However, in practice the selection is deterministic and completely depends on the chosen starting points (using `start`).

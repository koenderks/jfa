...
Simple examples can be found in the package vignettes: [jfa: Bayesian
and classical audit
sampling](https://koenderks.github.io/jfa/articles/jfa.html) and [jfa:
The audit sampling
workflow](https://koenderks.github.io/jfa/articles/auditWorkflow.html).
...
`jfa` is being verified against the following benchmarks:

...
namespace model_beta_poisson_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 16, column 2 to column 10)",
                                                      ...
                                                      " (in 'string', line 32, column 17 to line 34, column 3)",
                                                      ...
                                                      " (in 'string', line 27, column 4 to column 54)",
                                                      " (in 'string', line 26, column 17 to line 28, column 3)",
                                                      ...
                                                      " (in 'string', line 17, column 27 to column 28)",
                                                      " (in 'string', line 31, column 27 to column 28)"};
#include <stan_meta_header.hpp>
class model_beta_poisson final : public model_base_crtp<model_beta_poisson> {
private:
  int S;
  int n;
  std::vector<int> s;
...
public:
  ...
  inline std::string model_name() const final { return "model_beta_poisson"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_beta_poisson(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_beta_poisson_namespace::model_beta_poisson";
    ...
    try {
      ...
      validate_non_negative_index("phi", "S", S);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_beta_poisson_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      phi = Eigen::Matrix<local_scalar_t__, -1, 1>(S);
      ...
      assign(phi, nil_index_list(),
        inv_logit(add(mu, multiply(sigma, alpha_s))),
      ...
      for (int sym1__ = 1; sym1__ <= S; ++sym1__) {
        current_statement__ = 6;
        current_statement__ = 6;
        check_less_or_equal(function__, "phi[sym1__]", phi[(sym1__ - 1)], 1);
      }
      {
        ...
        for (int i = 1; i <= n; ++i) {
          ...
          lp_accum__.add(
            beta_lpdf<propto__>(t[(i - 1)], (phi[(s[(i - 1)] - 1)] * nu),
              ((1 - phi[(s[(i - 1)] - 1)]) * nu)));}
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_beta_poisson_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"theta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"alpha_s\",\"type\":{\"name\":\"vector\",\"length\":" << S << "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" << S << "},\"block\":\"transformed_parameters\"},{\"name\":\"theta_s\",\"type\":{\"name\":\"vector\",\"length\":" << S << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_beta_poisson_namespace::model_beta_poisson;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_beta_poisson_namespace::profiles__;
}
#endif
#endif

...
#include "stanExports_beta_poisson.h"

RCPP_MODULE(stan_fit4beta_poisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_beta_poisson")

...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 22, column 2 to column 44)",
...
class model_beta_binomial final : public model_base_crtp<model_beta_binomial> {
private:
  int S;
  int n;
  std::vector<int> s;
...
public:
  ...
  inline std::string model_name() const final { return "model_beta_binomial"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_beta_binomial_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
using stan_model = model_beta_binomial_namespace::model_beta_binomial;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_beta_binomial_namespace::profiles__;
}
#endif
#endif

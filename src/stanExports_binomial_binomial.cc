...
#include "stanExports_binomial_binomial.h"

RCPP_MODULE(stan_fit4binomial_binomial_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_binomial_binomial")
